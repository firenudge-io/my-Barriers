    ...
    return (
        <form className="flex flex-col gap-4 z-0">
            ...
            <div className="w-11/12 xl:w-3/4 mx-auto">
                ...
                <Textarea placeholder="Time frame" required={true} onChange={(e) => {
                ...
                <Textarea placeholder="The Worst Outcome" required={true} onChange={(e) => {
                ...
                <div className="mt-4 mb-2 block">
                    <Label
                        className="text-lg"
                        value="Prepare for it"
                    />
                </div>
                <Textarea placeholder="How can you prepare for it" onChange={(e) => {
                ...
                <div className="mt-4 mb-2 block">
                    <Label
                        className="text-lg"
                        value="Make it less worse"
                    />
                </div>
                <Textarea placeholder="How can you make it less worse" onChange={(e) => {
