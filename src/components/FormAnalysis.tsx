            ...
            <div className="w-11/12 xl:w-3/4 mx-auto">
                ...
                <div className="flex flex-row justify-center mt-10 mb-5">
                    <div className="inline-flex rounded-md shadow-sm" role="group">
                        <button className="px-4 py-2 text-sm rounded-l-lg font-medium bg-gray-100 text-blue-700 dark:text-white dark:bg-gray-600 cursor-default">
                            Analysis
                        </button>
                        <Link to="/my-Barriers/Classic">
                ...
                <div className="mt-4 mb-2 block">
                    <Label
                        className="text-lg"
                        value="Worrying about"
                    />
                </div>
                <Textarea placeholder="What am I worrying about" required={true} onChange={(e) => {
                ...
                <Textarea placeholder="List of all the things I can do" required={true} onChange={(e) => {
                ...
                <Textarea placeholder="What I'm going to do" onChange={(e) => {
                ...
                <Textarea placeholder="When I'm going to do" onChange={(e) => {
