...
const Nav_Items = [
    { name: "Home", link: "/my-Barriers/" },
    { name: "Archives", link: "/my-Barriers/Archives" },
]
        ...
        <div className="sticky top-0 shadow-sm bg-white dark:bg-gray-800 z-50">
            <Navbar fluid={true} rounded={true} className="container bg-white dark:bg-gray-800 mx-auto">
                <Link
                    ...
                    to={Nav_Items[0].link}>
                    <Navbar.Brand>
                        <img src="https://raw.githubusercontent.com/dependabot-pr/Static-Files/main/Assets/my/Barriers.svg" className="mr-3 h-6 sm:h-9 rounded-lg" alt="Logo" />
